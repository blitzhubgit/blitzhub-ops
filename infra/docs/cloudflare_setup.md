...
Cloudflare's Load Balancer ensures high availability and optimal traffic distribution.
  ...
  - **Frontend Pool**:
    ...
    - Steps in Cloudflare dashboard:
      ...
      3. Create Health Check:
         ...
         - Interval: 10 seconds
         - Timeout: 5 seconds
  - **Failover**: If A1.Flex fails (e.g., EU-FE-01), traffic is rerouted to E2.1.Micro VMs (EU-FE-E2-01, EU-FE-E2-02).
- **Geo-Steering**:
...
- **Backend Servers (EU-BE-01, NA-BE-01)**:
  - API requests (e.g., `/api/buy`) are routed through Cloudflare to Backend servers after WAF and rate limiting checks.
